...
$settings =  array(
    'single_method' => array(
        'title' 		=> __( 'Single method', 'ciudades-del-peru-para-woocommerce-2021' ),
        'type' 			=> 'select',
        'description' 	=> __( 'When doing single shipping method, it eliminates all others and imposes its own rules', 'ciudades-del-peru-para-woocommerce-2021' ),
    ...
    'cost' => array(
        'title' => __('Coste', 'ciudades-del-peru-para-woocommerce-2021'),
        'type' 			=> 'text',
    ...
    'cities' => array(
        'title' => __('Cities','ciudades-del-peru-para-woocommerce-2021'),
        'type' => 'multiselect',
        'class'       => 'wc-enhanced-select',
        'description' => __( 'Select the city referring to the region that you have previously added', 'ciudades-del-peru-para-woocommerce-2021' ),
